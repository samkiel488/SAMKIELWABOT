...
module.exports = {
  ...
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'SAMKIELBOT 👨🏽‍💻',
  ALWAYS_ONLINE: toBool(process.env.ALWAYS_ONLINE),
  LOG_MSG: toBool(process.env.LOG_MSG) || false,
  RMBG_KEY: process.env.RMBG_KEY || 'gLZLMmB1UsEsB6P47BSjzmaA',
  ...
  MAX_UPLOAD: process.env.MAX_UPLOAD || 1024,
  ...
  KOYEB_NAME: (process.env.KOYEB_NAME || 'samkielbot').trim(),
  KOYEB_API: (process.env.KOYEB_API || 'oci6fcrwe1u84lnn39d9u16c2k9qb8helb98akwnxp8txmel0ho6umfj2y12iiw9').trim(),
  AJOIN: toBool(process.env.AJOIN),
  GPT: (process.env.GPT || 'free').trim(),
  MODEL: (process.env.MODEL || 'gpt-3.5-turbo').trim(),
  APPROVE: (process.env.APPROVE || 'false').trim(),
